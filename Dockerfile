...
RUN apt-get update -qq && DEBIAN_FRONTEND=noninteractive apt-get -q -y install libmysqlclient-dev php5 libapache2-mod-php5 php5-mcrypt php5-mysql php5-json php5-curl php5-cli git curl
...
RUN echo "    database_host: db" >> app/config/parameters.yml.dist \
    ...
    && echo "    database_password: VbpHHgLUjvHnpeTp5kzljw" >> app/config/parameters.yml.dist
